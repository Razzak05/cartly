...
router.get("/", async (req, res) => {
  try {
    ...
    // Search functionality (case-insensitive search on name & description)
    if (search) {
      query.$or = [
...
// @desc Retriveve similar products based on the current product's gender and category
// @access Public
